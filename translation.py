...
def generate_tags_chat(prompt_text):
    response = client.chat.completions.create(
        ...
        messages=[
            {
                "role": "system",
                "content": "You will be provided with a block of text , and your task is to convert the text into Spanish and it should be according to the timestamps. In the ouput file, add '--' for specific pauses and when this is read it should be of 53 seconds.",
            },
            {
                "role": "user",
                "content": """ 1
